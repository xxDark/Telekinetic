...
public final class SimpleEventBus implements EventBus {
    ...
    @Override
    public RegisteredListener registerListeners(Object mod) {
        BusRegisteredListener listener = null;
        for (val m : mod.getClass().getDeclaredMethods()) {
            val annotation = m.getAnnotation(Listener.class);
            ...
            val eventExecutor = ASMEventExecutor.generateExecutor(mod, m, loader);
